...
enum DesertWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: DesertWebStatus) -> Bool {
        switch (self, other) {
...
extension DesertWebStatus {
    static func == (lhs: DesertWebStatus, rhs: DesertWebStatus) -> Bool {

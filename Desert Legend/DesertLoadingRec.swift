...
protocol WebLoadable: AnyObject {
    var state: DesertWebStatus { get set }
...
final class DesertWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: DesertWebStatus = .standby
...
extension DesertWebLoader: WKNavigationDelegate {
